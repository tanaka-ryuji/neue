...
$Referer_check_domain = "localhost:8888";
...
$subject = "Studio Neue Webサイトのお問い合わせ";
...
$require = array('社名/団体名','ご担当者名','メールアドレス','お問い合わせ内容');
...
$refrom_name = "Studio Neue Corp.";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせを受付致しました";
...
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
　※本メールは自動配信メールです。
　※本メールは、株式会社スタジオノイエ Webサイトより
　お問い合わせをされた方にお送りしています。
　お心当たりが無い場合は、このメールを破棄してください。
　またその旨、hato@neue.co.jpまでご連絡いただければ幸いです。
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
...
<head>
	...
	<title>Contact | Studio Neue Corp.</title>
	<meta property="og:url" content="http://www.neue.co.jp">
	<meta property="og:title" content="Contact | Studio Neue Corp.">
    ...
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Contact | Studio Neue Corp.">
...
<?php if($empty_flag == 1){ ?>
<div align="center">
<p class="attention">入力にエラーがあります。下記をご確認の上［戻る］ボタンにて修正をお願い致します。</p>
<?php echo $errm; ?>
<div class="box-button">
<input class="btn-single" type="button" value=" 戻る " onClick="history.back()">
</div>
</div>
<?php }else{ ?>
<h2>確認画面</h2>
...
送信ありがとうございました。<br />
送信は正常に完了しました。<br /><br />
<a href="<?php echo $site_top ;?>">トップページへ&raquo;</a>
</div>
<?php copyright(); ?>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><p class="attention">入力にエラーがあります。下記をご確認の上［戻る］ボタンにて修正をお願い致します。</p><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 戻る " onClick="history.back()"></div>
<?php 
